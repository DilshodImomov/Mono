  ...
  return (
    ...
    <header>
      <div data-aos="fade-left" data-aos-duration="1000" className='body'>
        ...
        <img data-aos="fade-down-left" data-aos-delay="700" className="techImage1" src={techImage1}/>
      </div>
    </header>
    <section>
      <div data-aos="fade-right" data-aos-duration="1000" className='block-right white'>
        <img data-aos="fade-up-right" data-aos-delay="500" className="techImage2" src={techImage2}/>
        <div className="text">
    ...
    <section>
      <div data-aos="fade-right" data-aos-duration="1000" className='block-right white under'>
        <img data-aos="fade-right" data-aos-delay="800" data-aos-duration="1500" className="techImage4" src={techImage4}/>
        <div className="text">
    ...
    <section>
      <div data-aos="fade-left" data-aos-duration="1000" className='block-left white under2'>
        ...
        <img data-aos="fade-left"  data-aos-delay="800" className="analysisImg" src={analysis}/>
      </div>
    </section>
    <section>
      <div data-aos="fade-right" data-aos-duration="1000" className='block-right blue'>
        <img data-aos="fade-right"  data-aos-delay="800" className="analysisImg" src={prediction}/>
        <div className="text">
    ...
    <section>
      <div data-aos="fade-left" data-aos-duration="1000" className='block-left white'>
        ...
        <img data-aos="fade-left"  data-aos-delay="800" className="security" src={security}/>
      </div>
    </section>
    <section>
      <div data-aos="fade-right" data-aos-duration="1000" className="block-right white">
      ...
      <div className="our-partners">
        <h1 data-aos="fade-right" data-aos-duration="500" data-aos-delay="0">Our Partners</h1>
